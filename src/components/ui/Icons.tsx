...
// Taxonomy / Sustainability icon
export function TaxonomyIcon({ className }: IconProps) {
  return (
    <svg
...
// BER / Energy Rating icon
export function BERIcon({ className }: IconProps) {
  return (
    <svg
      className={cn('w-6 h-6', className)}
      viewBox="0 0 24 24"
...
// Ventilation icon
export function VentilationIcon({ className }: IconProps) {
  return (
    <svg
      className={cn('w-6 h-6', className)}
      viewBox="0 0 24 24"
...
// Air Leakage / Wind icon
export function AirLeakageIcon({ className }: IconProps) {
  return (
    <svg
      className={cn('w-6 h-6', className)}
      viewBox="0 0 24 24"
...
// Qualification / Certificate icon
...
// Coverage / Map icon
export function CoverageIcon({ className }: IconProps) {
  return (
    <svg
      className={cn('w-6 h-6', className)}
      viewBox="0 0 24 24"
...
// Asset Manager icon
export function AssetManagerIcon({ className }: IconProps) {
  return (
    <svg
      className={cn('w-6 h-6', className)}
      viewBox="0 0 24 24"
...
// Trust signal icon map helper
export function getTrustIcon(iconName: string, className?: string) {
  const icons: Record<string, React.ReactNode> = {
    experience: <ExperienceIcon className={className} />,
    qualification: <QualificationIcon className={className} />,
    membership: <MembershipIcon className={className} />,
    coverage: <CoverageIcon className={className} />,
  }
  return icons[iconName] || <CheckIcon className={className} />
}
