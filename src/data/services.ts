...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Professional Building Energy Rating certificates for residential and commercial properties across Ireland.',
    metaDescription: 'Professional BER Certificates in Ireland. Domestic and commercial BER assessments by qualified assessors with 20+ years experience. Fast, reliable service nationwide.',
    icon: 'ber',
    features: [
